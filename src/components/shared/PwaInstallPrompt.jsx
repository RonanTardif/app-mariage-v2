          ...
          >
            ...
            <ol className="space-y-3 text-sm text-stone-700">
              <li className="flex items-start gap-3">
                ...
                <span>Appuie sur le bouton <strong>Partager</strong> <IosShareIcon className="inline-block h-[1.15em] w-[0.87em] align-[-0.2em] mx-0.5" /> en bas de ton navigateur Safari</span>
              </li>
              <li className="flex items-start gap-3">
