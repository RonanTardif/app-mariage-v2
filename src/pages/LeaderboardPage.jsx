...
export function LeaderboardPage() {
  ...
  return (
    <div className="space-y-6 pb-8">
      ...
      {/* ─── Podium ─── */}
      <div className="rounded-3xl border border-stone-100 px-4 pt-6 pb-0 overflow-hidden" style={{ backgroundImage: `url(${import.meta.env.BASE_URL}assets/podium_background.png)`, backgroundSize: 'cover', backgroundPosition: 'top center' }}>
